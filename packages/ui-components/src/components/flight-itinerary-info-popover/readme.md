...
| `disableCloseOnOutsideClick` | `disable-close-on-outside-click` | Should the default behaviour to close the popover when user clicks outside it be disabled. If yes, the popover can only be closed either programmatically or by clicking the close icon.                                                                                                | `boolean`                                                                                                                                                                                                    | `undefined` |
